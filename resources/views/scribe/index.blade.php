...
<head>
    ...
    <title>Home University API</title>
...
<div class="tocify-wrapper">
    ...
    <ul id="toc">
            ...
            <li>Last updated: January 30 2021</li>
        </ul>
</div>
<div class="page-wrapper">
    ...
    <div class="content">
        <h1>Introduction</h1>
<p>API Documentation for Home University</p>
<p>This documentation aims to provide all the information you need to work with our API.</p>
<aside>As you scroll, you'll see code examples for working with the API in different programming languages in the dark area to the right (or as part of the content on mobile).
You can switch the language used with the tabs at the top right (or from the nav menu at the top left on mobile).</aside>
<script src="https://cdn.jsdelivr.net/npm/lodash@4.17.10/lodash.min.js"></script>
<script>
    var baseUrl = "http://home-university-api.test";
</script>
<script src="{{ asset("vendor/scribe/js/tryitout-2.4.2.js") }}"></script>
<blockquote>
<p>Base URL</p>
</blockquote>
<pre><code class="language-yaml">http://home-university-api.test</code></pre><h1>Authenticating requests</h1>
